...
const Footer = () => {
  return (
    <footer id='footer' className='h-2.5'>
      <div className='px-2 sm:px-25 py-1 bg-primary text-amber-50 flex justify-between items-center'>
        <p className='copyright'>© 2026 Yogesh Dhuri. All rights reserved.</p>
